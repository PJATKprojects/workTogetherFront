...
import { ProfileEditContent } from "@/components/profile/profile-edit-content";
      ...
      <Suspense fallback={<div className="min-h-[50vh]" />}>
        <AuthGuard locale={raw} loadingLabel={t.common.loading}>
          ...
          >
            ...
            <h1 className="text-3xl font-semibold">{t.profile.editTitle}</h1>
            <p className="mt-2 mb-7 text-muted-foreground">{t.profile.editSubtitle}</p>
            <ProfileEditContent messages={t} />
          </main>
        </AuthGuard>
      </Suspense>
