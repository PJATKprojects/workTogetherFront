...
export default async function LoginPage({ params, searchParams }: Props) {
  ...
  return (
    <>
      ...
      <div className="relative min-h-[100dvh] overflow-x-hidden lg:flex lg:items-center lg:justify-center lg:p-3">
        ...
        <div className="relative flex min-h-[100dvh] w-full flex-col overflow-hidden lg:mx-auto lg:min-h-[calc(100dvh-1.5rem)] lg:max-w-[1100px] lg:flex-row lg:rounded-2xl lg:border lg:border-border lg:bg-surface/70 lg:shadow-[0_26px_64px_-30px_rgb(15_23_42/0.45)] lg:backdrop-blur-xl">
          <LoginHeroPanel
            line1={L.panelLine1}
            line2={L.panelLine2}
          ...
          <div className="relative z-10 flex min-w-0 flex-1 flex-col overflow-hidden bg-surface/90 backdrop-blur-md">
            <div
              aria-hidden
            ...
            <main
              id="main-content"
              tabIndex={-1}
              className="relative z-[1] flex flex-1 flex-col justify-center px-4 py-5 sm:px-5 sm:py-6 lg:px-10 lg:py-8"
            >
